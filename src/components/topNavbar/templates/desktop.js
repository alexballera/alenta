...
<ul class="navbar-top-desktop right hide-on-med-and-down">
  <li><a class='dropdown-button waves-effect waves-blue' href='#' data-activates='dropdown'>Qué es Alenta<i class="material-icons">arrow_drop_down</i></a></li>
  <li class="waves-effect waves-blue active"><a href="" class="gotoconsultorio">Consultorios</a></li>
