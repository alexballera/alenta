...
<ul class="navbar-top-desktop right hide-on-med-and-down">
  ...
  <li class="waves-effect waves-blue" id="li-medicas"><a href="" class="gotomedicas">Áreas Médicas</a></li>
  <li class="waves-effect waves-blue" id="li-cirugias"><a href="" class="gotocirugias">Salas de Cirugía</a></li>
  <li class="waves-effect waves-blue" id="li-hotel"><a href="" class="gotohotel">Hotel</a></li>
  <li class="waves-effect waves-blue" id="li-contactenos"><a href="" class="gotocontactanos">Contactenos</a></li>
</ul>
`
